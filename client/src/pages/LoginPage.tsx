...
function mapLoginError(msg: string, fallback: string): string {
  if (msg.includes('Invalid login credentials')) return 'wrongCredentials'
...
export function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      const key = mapLoginError(msg, 'error')
      setError(t(`login.${key}`))
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.divider}>{t('login.orContinueWith')}</div>
